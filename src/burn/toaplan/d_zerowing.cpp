...
unsigned char __fastcall zerowingZ80In(unsigned short nAddress)
{
	nAddress &= 0xFF;
...
void __fastcall zerowingZ80Out(unsigned short nAddress, unsigned char nValue)
{
	nAddress &= 0xFF;
...
unsigned char __fastcall zerowingReadByte(unsigned int sekAddress)
{
	switch (sekAddress) {
		case 0x400001:
		case 0x4c0001:
...
unsigned short __fastcall zerowingReadWord(unsigned int sekAddress)
{
	switch (sekAddress) {
...
void __fastcall zerowingWriteByte(unsigned int sekAddress, unsigned char byteValue)
{
	switch (sekAddress) {
...
void __fastcall zerowingWriteWord(unsigned int sekAddress, unsigned short wordValue)
{
	switch (sekAddress) {
