...
static struct BurnRomInfo bbakraduRomDesc[] = {
...
static int bbakraidInit()
{
	...
	if (strcmp("bbakradu", BurnDrvGetTextA(DRV_NAME)) == 0) {
...
struct BurnDriver BurnDrvBattleBakraid = {
	"bbakraid", NULL, NULL, "1999",
	"Battle Bakraid (ver. Wed Apr 7 1999)\0", NULL, "Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvBattleBakraidU = {
	"bbakradu", "bbakraid", NULL, "1999",
	"Battle Bakraid - Unlimited Version (ver. Tue Jun 8 1999)\0", NULL, "Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
