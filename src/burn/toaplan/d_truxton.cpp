...
unsigned char __fastcall truxtonZ80In(unsigned short nAddress)
{
	nAddress &= 0xFF;
...
void __fastcall truxtonZ80Out(unsigned short nAddress, unsigned char nValue)
{
	nAddress &= 0xFF;
...
unsigned char __fastcall truxtonReadByte(unsigned int sekAddress)
{
	switch (sekAddress) {
		case 0x0c0001:
		case 0x140001:
...
unsigned short __fastcall truxtonReadWord(unsigned int sekAddress)
{
	switch (sekAddress) {
...
void __fastcall truxtonWriteByte(unsigned int sekAddress, unsigned char byteValue)
{
	switch (sekAddress) {
...
void __fastcall truxtonWriteWord(unsigned int sekAddress, unsigned short wordValue)
{
	switch (sekAddress) {
