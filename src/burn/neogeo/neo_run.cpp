...
#define QUARK_LOG_MODULE "NEO_RUN"
#include "ggpo_log.h"
...
int NeoFrame()
{
	...
	while (SekTotalCycles() < nCyclesSegment) {
		...
		if (nCyclesSegment < nIRQCycles || SekTotalCycles() >= nIRQCycles) {
         QUARK_LOG_STR("Callsite C.");
         QUARK_LOG_VAR(nCyclesSegment);
         QUARK_LOG_VAR(SekTotalCycles());
			SekRun(nCyclesSegment - SekTotalCycles());
         QUARK_LOG_STR("Callsite C Done.");
		} else {
         QUARK_LOG_STR("Callsite D.");
         QUARK_LOG_VAR(nIRQCycles);
         QUARK_LOG_VAR(SekTotalCycles());
	...
	if (bRenderLineByLine) {
		...
		while (SekTotalCycles() < nCyclesVBlank) {
			...
			if (nCyclesSegment < nIRQCycles || SekTotalCycles() >= nIRQCycles) {
            QUARK_LOG_STR("Callsite E.");
            QUARK_LOG_VAR(nCyclesSegment);
            QUARK_LOG_VAR(SekTotalCycles());
				SekRun(nCyclesSegment - SekTotalCycles());
			} else {
            QUARK_LOG_STR("Callsite F.");
            QUARK_LOG_VAR(nIRQCycles);
            QUARK_LOG_VAR(SekTotalCycles());
				SekRun(nIRQCycles - SekTotalCycles());
			}
		...
		while (SekTotalCycles() < nCyclesVBlank) {
			...
			if (nCyclesSegment < nIRQCycles || SekTotalCycles() >= nIRQCycles) {
            QUARK_LOG_STR("Callsite G.");
            QUARK_LOG_VAR(nCyclesSegment);
            QUARK_LOG_VAR(SekTotalCycles());
				SekRun(nCyclesSegment - SekTotalCycles());
			} else {
            QUARK_LOG_STR("Callsite H.");
            QUARK_LOG_VAR(nIRQCycles);
            QUARK_LOG_VAR(SekTotalCycles());
				SekRun(nIRQCycles - SekTotalCycles());
			}
	...
	while (SekTotalCycles() < nCyclesSegment) {
		...
		if (nCyclesSegment < nIRQCycles || SekTotalCycles() >= nIRQCycles) {
         QUARK_LOG_STR("Callsite I.");
         QUARK_LOG_VAR(nCyclesSegment);
         QUARK_LOG_VAR(SekTotalCycles());
			SekRun(nCyclesSegment - SekTotalCycles());
		} else {
         QUARK_LOG_STR("Callsite J.");
         QUARK_LOG_VAR(nIRQCycles);
         QUARK_LOG_VAR(SekTotalCycles());
			SekRun(nIRQCycles - SekTotalCycles());
		}
