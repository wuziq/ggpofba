...
static UINT16 fd1089_decrypt(/*offs_t*/int addr,UINT16 val,const UINT8 *key,int opcode)
{
	...
	if (BurnDrvGetHardwareCode() & HARDWARE_SEGA_FD1089A_ENC) src = decode_fd1089a(src,key[tbl_num + opcode * 0x1000],opcode);
	if (BurnDrvGetHardwareCode() & HARDWARE_SEGA_FD1089B_ENC) src = decode_fd1089b(src,key[tbl_num + opcode * 0x1000],opcode);
