...
static struct BurnDIPInfo Outrun1DIPList[]=
{
	// Default Values
	{0x0a, 0xff, 0xff, 0xff, NULL                                 },
...
static struct BurnDIPInfo Toutrun2DIPList[]=
{
	// Default Values
	{0x0b, 0xff, 0xff, 0xff, NULL                                 },
	...
	// Dip 2
	{0   , 0xfe, 0   , 4   , "Cabinet"                            },
	{0x0c, 0x01, 0x03, 0x03, "No use"                             },
	{0x0c, 0x01, 0x03, 0x02, "No use"                             },
	{0x0c, 0x01, 0x03, 0x01, "No use"                             },
	{0x0c, 0x01, 0x03, 0x00, "Cockpit"                            },
...
static struct BurnRomInfo Outrun1RomDesc[] = {
...
STD_ROM_PICK(Outrun1);
STD_ROM_FN(Outrun1);

static struct BurnRomInfo Outrun2RomDesc[] = {
...
static struct BurnRomInfo ShangonRomDesc[] = {
	...
	{ "epr-10884.117",    0x10000, 0x70795f26, SYS16_ROM_PROG | BRF_ESS | BRF_PRG },
...
static struct BurnRomInfo ShangnleRomDesc[] = {
...
struct BurnDriver BurnDrvOutrunb = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_SEGA_OUTRUN | HARDWARE_SEGA_SPRITE_LOAD32,
...
struct BurnDriver BurnDrvShangon = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_SEGA_OUTRUN,
...
struct BurnDriver BurnDrvShangon2 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_SEGA_OUTRUN | HARDWARE_SEGA_FD1089B_ENC,
...
struct BurnDriver BurnDrvShangnle = {
	"shangnle", "shangon", NULL, "1991",
	"Limited Edition Hang-On\0", NULL, "Sega", "Out Run",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_SEGA_OUTRUN,
...
struct BurnDriver BurnDrvToutrun2 = {
