// CPS - Run
#include "cps.h"
#define QUARK_LOG_MODULE "CPS_RUN"
#include "ggpo_log.h"
...
int CpsRunInit()
{
	...
	if (Cps == 2 || PangEEP) {				// EEPROM init (64 16bit words)
		...
		if (Cps1Qs == 1) {
			EEPROMInit(1024, 8);			// EEPROM init (128 bytes)
		}
	}
